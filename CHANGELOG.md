...
- Add support for collapsing networks ([#1867](https://github.com/thelounge/thelounge/pull/1867), [#2225](https://github.com/thelounge/thelounge/pull/2225), [#2195](https://github.com/thelounge/thelounge/pull/2195) by [@McInkay](https://github.com/McInkay))
...
- Add SQLite logging and reloading messages ([#1839](https://github.com/thelounge/thelounge/pull/1839) by [@xPaw](https://github.com/xPaw))
...
- Allow hiding channel list on desktop ([#2212](https://github.com/thelounge/thelounge/pull/2212), [#2235](https://github.com/thelounge/thelounge/pull/2235) by [@xPaw](https://github.com/xPaw), [#2246](https://github.com/thelounge/thelounge/pull/2246) by [@astorije](https://github.com/astorije))
...
- Turn channel list into an accessible tablist ([#1915](https://github.com/thelounge/thelounge/pull/1915) by [@xPaw](https://github.com/xPaw))
...
- Upgrade to Font Awesome 5 ([#2194](https://github.com/thelounge/thelounge/pull/2194) by [@xPaw](https://github.com/xPaw))
...
- Do not aggressively focus input when clicking anywhere and handle typing out of focus ([#2215](https://github.com/thelounge/thelounge/pull/2215) by [@xPaw](https://github.com/xPaw))
...
- Update production dependencies to their latest versions:
  - `irc-framework` ([#2097](https://github.com/thelounge/thelounge/pull/2097), [#2575](https://github.com/thelounge/thelounge/pull/2575), [#2648](https://github.com/thelounge/thelounge/pull/2648), [#2826](https://github.com/thelounge/thelounge/pull/2826))
  ...
  - `sqlite3` ([#2238](https://github.com/thelounge/thelounge/pull/2238), [#2584](https://github.com/thelounge/thelounge/pull/2584), [#2651](https://github.com/thelounge/thelounge/pull/2651), [#2863](https://github.com/thelounge/thelounge/pull/2863), [#2894](https://github.com/thelounge/thelounge/pull/2894))
...
- Switch to Node v6 as the minimal supported version ([#1727](https://github.com/thelounge/thelounge/pull/1727) by [@astorije](https://github.com/astorije))
...
- Allow setting `rejectUnauthorized` per network ([#2075](https://github.com/thelounge/thelounge/pull/2075) by [@xPaw](https://github.com/xPaw))
...
- Use `attr()` on user-controlled data ([#2398](https://github.com/thelounge/thelounge/pull/2398) by [@xPaw](https://github.com/xPaw))
- Move correct file after upload, put file extension in slug ([#2749](https://github.com/thelounge/thelounge/pull/2749) by [@xPaw](https://github.com/xPaw))
...
- Switch from npm to yarn ([#1987](https://github.com/thelounge/thelounge/pull/1987) by [@xPaw](https://github.com/xPaw), [#2664](https://github.com/thelounge/thelounge/pull/2664) by [@fnutt](https://github.com/fnutt))
...
- Fixes in the config documentation ([#2882](https://github.com/thelounge/thelounge/pull/2882), [#2901](https://github.com/thelounge/thelounge/pull/2901) by [@xPaw](https://github.com/xPaw), [#2915](https://github.com/thelounge/thelounge/pull/2915) by [@MaxLeiter](https://github.com/MaxLeiter))
...
- Search feature ([#101](https://github.com/thelounge/thelounge.github.io/pull/101) by [@astorije](https://github.com/astorije))
...
- Rewrite install docs ([#104](https://github.com/thelounge/thelounge.github.io/pull/104) by [@astorije](https://github.com/astorije))
...
- Structure doc navigation, use Netlify for redirects ([#111](https://github.com/thelounge/thelounge.github.io/pull/111) by [@astorije](https://github.com/astorije))
...
- Re-write documentation about server usage (and replace `--home` with `THELOUNGE_HOME` ([#116](https://github.com/thelounge/thelounge.github.io/pull/116) by [@astorije](https://github.com/astorije))
...
- Add a guide about reverse proxies ([#119](https://github.com/thelounge/thelounge.github.io/pull/119) by [@astorije](https://github.com/astorije))
...
- Add a very high-level overview of CTCP in guides ([#122](https://github.com/thelounge/thelounge.github.io/pull/122) by [@astorije](https://github.com/astorije))
...
- Netlify redirects ([#127](https://github.com/thelounge/thelounge.github.io/pull/127) by [@astorije](https://github.com/astorije), [`7d292de`](https://github.com/thelounge/thelounge.github.io/commit/7d292de970303f257e8304179a6affa8d0de4fb9) by [@xPaw](https://github.com/xPaw))
...
- Add an upgrade guide and extract abbreviations into a shared file ([#136](https://github.com/thelounge/thelounge.github.io/pull/136) by [@astorije](https://github.com/astorije))
...
- Link to relevant config section ([#141](https://github.com/thelounge/thelounge.github.io/pull/141) by [@xPaw](https://github.com/xPaw))
...
- Heroku install: Use `--config` in favor of removed `--private` ([#143](https://github.com/thelounge/thelounge.github.io/pull/143) by [@astorije](https://github.com/astorije))
...
- Kill the Heroku docs ([#177](https://github.com/thelounge/thelounge.github.io/pull/177) by [@astorije](https://github.com/astorije))
...
- Add `X-Forwarded-Proto` to reverse proxy configs ([#182](https://github.com/thelounge/thelounge.github.io/pull/182) by [@xPaw](https://github.com/xPaw))
- Fix example commands ([`3435c87`](https://github.com/thelounge/thelounge.github.io/commit/3435c87b9937ce3153607915f4dcfb6dffd13f53) by [@xPaw](https://github.com/xPaw))

### Internals

- Skip scripts folder from test coverage ([#2076](https://github.com/thelounge/thelounge/pull/2076) by [@xPaw](https://github.com/xPaw))
- Enable `no-var` rule ([#1962](https://github.com/thelounge/thelounge/pull/1962) by [@xPaw](https://github.com/xPaw))
...
- Refactor channel titles to use flexbox ([#2113](https://github.com/thelounge/thelounge/pull/2113) by [@xPaw](https://github.com/xPaw))
...
- Minor optimization in style parser ([#2408](https://github.com/thelounge/thelounge/pull/2408) by [@xPaw](https://github.com/xPaw))
...
- Refactor `userLog` to be the same as SQLite logger ([#2366](https://github.com/thelounge/thelounge/pull/2366) by [@xPaw](https://github.com/xPaw))
...
- Minify handlebars templates ([#2498](https://github.com/thelounge/thelounge/pull/2498) by [@xPaw](https://github.com/xPaw))
- Remove `log` from `global` ([#2563](https://github.com/thelounge/thelounge/pull/2563) by [@xPaw](https://github.com/xPaw))
...
- Add auto-prepend behaviour for unprefixed channel names ([#2289](https://github.com/thelounge/thelounge/pull/2289) by [@lol768](https://github.com/lol768))
...
- Improve UI of previews ([#2272](https://github.com/thelounge/thelounge/pull/2272) by [@astorije](https://github.com/astorije))
...
- Add 'op' and 'voice' user context menu items ([#2355](https://github.com/thelounge/thelounge/pull/2355) by [@Jay2k1](https://github.com/Jay2k1))
- Count quits as parts in condensed messages to reduce information density ([#2386](https://github.com/thelounge/thelounge/pull/2386) by [@xPaw](https://github.com/xPaw))
- Favicons, favicons everywhere ([#2009](https://github.com/thelounge/thelounge/pull/2009) by [@astorije](https://github.com/astorije))
...
- Add 512px icons in manifest and specify image types ([#2431](https://github.com/thelounge/thelounge/pull/2431) by [@xPaw](https://github.com/xPaw))
...
- Allow connecting/disconnecting from networks in UI, closes #631 ([#2114](https://github.com/thelounge/thelounge/pull/2114) by [@MaxLeiter](https://github.com/MaxLeiter))
- Focus into input if trying to type into any non-input element ([#2536](https://github.com/thelounge/thelounge/pull/2536) by [@xPaw](https://github.com/xPaw))
...
- Make non-highlighted favicon look more different than highlighted one ([#2540](https://github.com/thelounge/thelounge/pull/2540) by [@astorije](https://github.com/astorije))
- Add alert count to title  ([#2496](https://github.com/thelounge/thelounge/pull/2496) by [@Jay2k1](https://github.com/Jay2k1))
...
- Replace current red-text highlight with a full background-color highlight ([#2526](https://github.com/thelounge/thelounge/pull/2526) by [@astorije](https://github.com/astorije))
...
- Warn if config owner doesn't match process uid ([#2570](https://github.com/thelounge/thelounge/pull/2570) by [@xPaw](https://github.com/xPaw))
...
- Make the MOTDs a little nicer if possible ([#2633](https://github.com/thelounge/thelounge/pull/2633) by [@astorije](https://github.com/astorije))
- Use monospace font for MOTD, set an icon, fix new line trimming ([#2653](https://github.com/thelounge/thelounge/pull/2653) by [@xPaw](https://github.com/xPaw))
- Improve inline documentation of config defaults and use it to generate website counterpart ([#2645](https://github.com/thelounge/thelounge/pull/2645) by [@astorije](https://github.com/astorije))
- Make userlist section titles sticky on scroll, improve contrasts for accessibility, use CSS variables ([#2643](https://github.com/thelounge/thelounge/pull/2643) by [@astorije](https://github.com/astorije))
...
- Fix confirmation box text for network removal in client ([#2715](https://github.com/thelounge/thelounge/pull/2715) by [@fnutt](https://github.com/fnutt))
...
- Add file uploading support ([#2552](https://github.com/thelounge/thelounge/pull/2552) by [@MaxLeiter](https://github.com/MaxLeiter))
- Replace normal icon with the transparent version ([#2755](https://github.com/thelounge/thelounge/pull/2755) by [@McInkay](https://github.com/McInkay))
- Enable underlines on links ([#2618](https://github.com/thelounge/thelounge/pull/2618) by [@xPaw](https://github.com/xPaw))
- Add hover underline on preview expand button ([#2790](https://github.com/thelounge/thelounge/pull/2790) by [@xPaw](https://github.com/xPaw))
...
- Fix active class not being removed when switching channels ([#2078](https://github.com/thelounge/thelounge/pull/2078) by [@xPaw](https://github.com/xPaw))
- Rewrite ctcp handling ([#1928](https://github.com/thelounge/thelounge/pull/1928) by [@xPaw](https://github.com/xPaw))
- Add titles to all windows ([#2079](https://github.com/thelounge/thelounge/pull/2079) by [@xPaw](https://github.com/xPaw))
...
- Channel leave button tooltip to correspond with right click context menu ([#2115](https://github.com/thelounge/thelounge/pull/2115) by [@fnutt](https://github.com/fnutt))
- Revert "Allow scaling the page" ([#2122](https://github.com/thelounge/thelounge/pull/2122) by [@astorije](https://github.com/astorije))
- Bring back line-height on messages ([#2140](https://github.com/thelounge/thelounge/pull/2140) by [@xPaw](https://github.com/xPaw))
...
- Fix rejectUnauthorized ([#2154](https://github.com/thelounge/thelounge/pull/2154) by [@xPaw](https://github.com/xPaw))
- Cleanup chat/userlist to use flexbox, fix a couple of bugs ([#2150](https://github.com/thelounge/thelounge/pull/2150) by [@xPaw](https://github.com/xPaw))
- Fix chat and userlist not scrolling ([#2160](https://github.com/thelounge/thelounge/pull/2160) by [@xPaw](https://github.com/xPaw))
- Fix default ecdh curve for better compatibility ([#2159](https://github.com/thelounge/thelounge/pull/2159) by [@xPaw](https://github.com/xPaw))
- Apply ECDH curve fix only on affected version ([#2163](https://github.com/thelounge/thelounge/pull/2163) by [@xPaw](https://github.com/xPaw))
...
- Only request `znc.in/playback` if sqlite logging is enabled ([#2188](https://github.com/thelounge/thelounge/pull/2188) by [@xPaw](https://github.com/xPaw))
...
- Close sqlite database when user quits ([#2190](https://github.com/thelounge/thelounge/pull/2190) by [@xPaw](https://github.com/xPaw))
- Fix join and part icons ([#2205](https://github.com/thelounge/thelounge/pull/2205) by [@xPaw](https://github.com/xPaw))
...
- Do not try to write anything to sqlite after it is closed ([#2222](https://github.com/thelounge/thelounge/pull/2222) by [@xPaw](https://github.com/xPaw))
...
- Keep input reference as jquery object ([#2242](https://github.com/thelounge/thelounge/pull/2242) by [@xPaw](https://github.com/xPaw))
...
- Unfocus input on touch devices to close the keyboard ([#2258](https://github.com/thelounge/thelounge/pull/2258) by [@xPaw](https://github.com/xPaw))
...
- Do not close sidebar when collapsing networks ([#2298](https://github.com/thelounge/thelounge/pull/2298) by [@xPaw](https://github.com/xPaw))
- Fix bug preventing to click on channels/queries ([#2305](https://github.com/thelounge/thelounge/pull/2305) by [@astorije](https://github.com/astorije))
- Catch `stderr` from yarn subprocess ([#2303](https://github.com/thelounge/thelounge/pull/2303) by [@benharri](https://github.com/benharri))
...
- Re-include latest Node.js v9 version in Travis build ([#2312](https://github.com/thelounge/thelounge/pull/2312) by [@astorije](https://github.com/astorije))
- Fix autocomplete selection when hitting Enter ([#2314](https://github.com/thelounge/thelounge/pull/2314) by [@astorije](https://github.com/astorije))
...
- Enable sync on empty localstorage, force sync, sync on both load and reconnect. ([#2317](https://github.com/thelounge/thelounge/pull/2317) by [@creesch](https://github.com/creesch))
- Fix previews on Morning (and others) ([#2349](https://github.com/thelounge/thelounge/pull/2349) by [@astorije](https://github.com/astorije))
...
- Make condensed joins and parts shorter ([#2383](https://github.com/thelounge/thelounge/pull/2383) by [@xPaw](https://github.com/xPaw))
...
- Correctly add quits to parts ([#2392](https://github.com/thelounge/thelounge/pull/2392) by [@xPaw](https://github.com/xPaw))
- Fix `aria-controls` on collapse button ([#2399](https://github.com/thelounge/thelounge/pull/2399) by [@xPaw](https://github.com/xPaw))
- Fix channel and ban lists in context menu not working ([#2406](https://github.com/thelounge/thelounge/pull/2406) by [@xPaw](https://github.com/xPaw))
...
- Allow out-of-focus typing on touch devices ([#2416](https://github.com/thelounge/thelounge/pull/2416) by [@xPaw](https://github.com/xPaw))
- Fix merge() in parser not filling unstyled text correctly ([#2428](https://github.com/thelounge/thelounge/pull/2428) by [@xPaw](https://github.com/xPaw))
...
- Gracefully fail if sqlite3 module fails to load ([#2391](https://github.com/thelounge/thelounge/pull/2391) by [@xPaw](https://github.com/xPaw))
- Fix join channel form not working ([#2414](https://github.com/thelounge/thelounge/pull/2414) by [@xPaw](https://github.com/xPaw))
...
- Pointer cursor hovering nicks in userlist ([#2445](https://github.com/thelounge/thelounge/pull/2445) by [@MaxLeiter](https://github.com/MaxLeiter))
...
- Fix Alt+Up/Down cycling through channels of collapsed networks ([#2388](https://github.com/thelounge/thelounge/pull/2388) by [@Raqbit](https://github.com/Raqbit))
- Undo webpack sorting, it made network always locked ([#2502](https://github.com/thelounge/thelounge/pull/2502) by [@dgw](https://github.com/dgw))
...
- Don't mark your nick changes as self in each channel ([#2505](https://github.com/thelounge/thelounge/pull/2505) by [@xPaw](https://github.com/xPaw))
...
- Fix adding a new network expanding collapsed networks incorrectly ([#2530](https://github.com/thelounge/thelounge/pull/2530) by [@xPaw](https://github.com/xPaw))
...
- Restore whitespace between caret and More/Less text in previews ([#2539](https://github.com/thelounge/thelounge/pull/2539) by [@astorije](https://github.com/astorije))
- Mark sqlite3 as an optional dependency ([#2541](https://github.com/thelounge/thelounge/pull/2541) by [@astorije](https://github.com/astorije))
- Fix sqlite history not loading when maxHistory is -1 ([#2546](https://github.com/thelounge/thelounge/pull/2546) by [@xPaw](https://github.com/xPaw))
...
- Synchronise number of highlighted messages to client ([#2547](https://github.com/thelounge/thelounge/pull/2547) by [@xPaw](https://github.com/xPaw))
- Remove label on force sync button ([#2544](https://github.com/thelounge/thelounge/pull/2544) by [@xPaw](https://github.com/xPaw))
...
- Fix undefined channel when updating title ([#2558](https://github.com/thelounge/thelounge/pull/2558) by [@xPaw](https://github.com/xPaw))
...
- Fix circular dependency in Helper+log ([#2569](https://github.com/thelounge/thelounge/pull/2569) by [@xPaw](https://github.com/xPaw))
...
- Fix highlights when seconds are shown in timestamps ([#2585](https://github.com/thelounge/thelounge/pull/2585) by [@astorije](https://github.com/astorije))
- Switch close button text on channels to Leave and kept as Close for other types. ([#2593](https://github.com/thelounge/thelounge/pull/2593) by [@MaxLeiter](https://github.com/MaxLeiter))
- Disable username autocapitalize on input field when signing on ([#2617](https://github.com/thelounge/thelounge/pull/2617) by [@fnutt](https://github.com/fnutt))
- Make userlist state consistent on mobile and desktop ([#2599](https://github.com/thelounge/thelounge/pull/2599) by [@xPaw](https://github.com/xPaw))
- Fix incorrect target in (dis)connect context menu ([#2626](https://github.com/thelounge/thelounge/pull/2626) by [@xPaw](https://github.com/xPaw))
...
- Fix incorrect left padding for highlights on mobile ([#2622](https://github.com/thelounge/thelounge/pull/2622) by [@astorije](https://github.com/astorije))
...
- use replace over trimEnd to support ff60 ([#2657](https://github.com/thelounge/thelounge/pull/2657) by [@MiniDigger](https://github.com/MiniDigger))
- Don't put .log in text log folder name ([#2670](https://github.com/thelounge/thelounge/pull/2670) by [@xPaw](https://github.com/xPaw))
...
- Make menu state consistent on desktop and mobile; fix sliding on desktop ([#2601](https://github.com/thelounge/thelounge/pull/2601) by [@xPaw](https://github.com/xPaw))
...
- Disable file uploads by default until the UX is better ([#2743](https://github.com/thelounge/thelounge/pull/2743) by [@xPaw](https://github.com/xPaw))
- Remove incorrect closing tag ([#2744](https://github.com/thelounge/thelounge/pull/2744) by [@xPaw](https://github.com/xPaw))
- Only emit upload url to the client that uploaded the file ([#2748](https://github.com/thelounge/thelounge/pull/2748) by [@xPaw](https://github.com/xPaw))
...
- Limit network name length and replace spaces in log folders ([#2764](https://github.com/thelounge/thelounge/pull/2764) by [@xPaw](https://github.com/xPaw))
- Fix fullscreen mode for videos ([#2775](https://github.com/thelounge/thelounge/pull/2775) by [@richrd](https://github.com/richrd))
- Fix automatically closing sidebar on some mobile viewports ([#2785](https://github.com/thelounge/thelounge/pull/2785) by [@williamboman](https://github.com/williamboman))
...
- Remove underline from textcomplete dropdown ([#2817](https://github.com/thelounge/thelounge/pull/2817) by [@xPaw](https://github.com/xPaw))
...
- Put unread and highlight counts in aria-label in the channel list ([#2828](https://github.com/thelounge/thelounge/pull/2828) by [@xPaw](https://github.com/xPaw))
- Remove aria-label on channels in channel list ([#2830](https://github.com/thelounge/thelounge/pull/2830) by [@xPaw](https://github.com/xPaw))
- Bring back aria-label to fix broken code ([#2840](https://github.com/thelounge/thelounge/pull/2840) by [@xPaw](https://github.com/xPaw))
...
- Force express server to run in production mode ([#2851](https://github.com/thelounge/thelounge/pull/2851) by [@xPaw](https://github.com/xPaw))
- Fix touch position being null when touching with multiple fingers ([#2854](https://github.com/thelounge/thelounge/pull/2854) by [@xPaw](https://github.com/xPaw))
...
- Fix missing colors dependency, simplify version warning ([#2907](https://github.com/thelounge/thelounge/pull/2907) by [@xPaw](https://github.com/xPaw))
